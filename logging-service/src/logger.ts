...
export const requestLogging = expressWinston.logger({
  ...
  format: process.env.NODE_ENV === 'prd' ? prodFormat() : devFormat(),
  meta: true, // optional: control whether you want to logs the meta data about the request (default to true)
  ...
  }, // optional: allows to skip some logs messages based on request and/or response
});
